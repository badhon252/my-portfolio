        ...
        <div className="container">
            ...
            <div className="skillSet__title__line">
                <div className="skillSet__title__line__inner">
                    I'm a experienced Frontend Web Application developer with more than 2 years of hands on experienced. I am adaptable and able to learn newtechnologies as needed.
                </div>
            </div>
            <SkillSet/>
        </div>
