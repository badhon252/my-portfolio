...
import webIcon from "../../../Assests/icons/icons8-web-design.svg"
import webIcon from "../../../Assests/icons/code-file.svg"
  ...
  return (
      <ul className="skills">
                    ...
                    <div className="skillSet__title__text">My Services</div>
                        ...
                        <li><img src={reduxIcon} alt="icon"/>Pixel Perfect Design</li>
                        <li><img src={reduxIcon} alt="icon"/>Modern Web App Development</li>
                    </div>
