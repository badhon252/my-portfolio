            ...
            <div className="container">
                ...
                <div className="row my-5">
                    <div className="col-md-4">
                        ...
                        text={"Experience the Future of Chatting with ChatGPT Version 2.0!"}
                        stack={["javascript", "nodejs", "git & gitub", "openaiAPI"]}
                       preview={"https://kind-murdock-61d8e5.netlify.app/"} link={"https://github.com/badhon252/todo-app"}
                        />
                    </div> 
                   <div className="col-md-4">
                        ...
                        text={"Experience the Future of Chatting with ChatGPT Version 2.0!"}
                        stack={["javascript", "nodejs", "git & gitub", "openaiAPI"]}
                       preview={} link={"https://github.com/badhon252/chatGPT-v2"}
                        />
                    </div> 
                    <div className="col-md-4">
                        ...
                        text={"Experience the Future of Chatting with ChatGPT Version 2.0!"}
                        stack={["javascript", "nodejs", "git & gitub", "openaiAPI"]}
                       preview={"https://badhon252.github.io/favor-food/"} link={"https://github.com/badhon252/chatGPT-v2"}
                        />
                    </div> 
                </div>
            </div>
