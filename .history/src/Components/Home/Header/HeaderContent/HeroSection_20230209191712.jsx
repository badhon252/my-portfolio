  ...
  return (
    <div className="heroSection">
          ...
          <div className={Classes.bio}>
            <div class="center">
             <p id="text">I"m a <span>Frontend Developer with a constant desire to grow, learn, and explore the world!</span> Passionate about crafting intuitive and engaging user experiences, 
