  ...
  return (
    <div className="heroSection">
          ...
          <div className={Classes.bio}>
             <p id={Classes.text}>I'm a <span>Frontend Developer with a constant desire to grow, learn, and explore the world!</span> Passionate about crafting intuitive and engaging user experiences, 
