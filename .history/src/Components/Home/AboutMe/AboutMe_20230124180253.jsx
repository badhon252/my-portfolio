            ...
            <div className="about-me">
                <div className="row">
                    <div className="col-md-8">
                        ...
                        <h3>EDUCATION:</h3>
                        <div className="edu">
                            <h4>Currently pursuing Bachelor's Degree in Computer Science & Engineering <br />
                                -  Global University Bangladesh | (Sep-2019)-(Aug-2023)</h4>
                            
                        </div>
                    </div>
                    <div className="col-md-4">
                        <img className="img-fluid border-circle" src={codingGif} alt="Software engineer's Avater" border="0" />
                    </div>
                </div>
