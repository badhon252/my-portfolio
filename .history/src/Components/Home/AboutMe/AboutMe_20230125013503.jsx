                    ...
                    <div className="col-md-8">
                        ...
                        <div id="edu" className="my-5">
                            ...
                            <h4 className="my-3">Currently pursuing Bachelor's Degree in Computer Science & Engineering <br />
                             <a href="">   <span> - Global University Bangladesh, Bangladesh | (Sep-2019)-(Aug-2023)</span> </a> 
                            </h4>
                            <h4 className="my-3">Higher Secondary Certificate (HSC) <br />
                               <a href=""><span> - Govt. Bakergonj College, Barishal, Bangladesh</span> </a> 
                            </h4>
                        </div>  
                        ...
                        <div id="certification" className="my-5">
                            ...
                            <h4 className="my-3">
                                Web design & development | <a href=""> <span>Bangladesh Hi-Tech Park Authority</span></a> 
                            </h4>
                            <h4 className="my-3">
                               Aptis (english) | <a href=""><span>British Council & Bangladesh Hi-Tech Park Authority</span></a> 
                            </h4>
                        </div>
