            ...
            <div className="about-me">
                <div className="row">
                    <div className="col-md-8">
                        ...
                        <div id="edu" className="my-5">
                        <h3 className="edu_title">CERTIFICATIONS</h3>
                            <h4 className="my-3">Currently pursuing Bachelor's Degree in Computer Science & Engineering <br />
                                <span> - Global University Bangladesh, Bangladesh | (Sep-2019)-(Aug-2023)</span> Web design & development | Bangladesh Hi-Tech Park Authority
                            </h4>
                            <h4 className="my-3">Web design & development | Bangladesh Hi-Tech Park Authority<br />
                                <span> - Govt. Bakergonj College, Barishal, Bangladesh</span> 
                            </h4>
                        </div>
                        

Aptis (english) | British Council & Bangladesh Hi-Tech Park Authority
